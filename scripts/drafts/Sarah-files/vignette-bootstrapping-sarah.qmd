...
__Keep in mind that bagging will lead to correlated trees, since all predictors are considered at each split.__
...
_Notice how the error decreases as the number of trees increases, i.e. as our random forest model is further trained._
...
__Does the number of decision trees affect the test set prediction performance of a bagged random forest model?__
...
__Does the random forest model provide any improvement over bagging, in this case?__
