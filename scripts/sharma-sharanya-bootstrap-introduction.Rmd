...
```{r}
library(imager)
bootstrap_diagram <- load.image("/Users/sharanya/Desktop/bootstrap-diagram.png")
...
for(i in 1:1000){
   sample_list[[i]] <- sample(c(1:1000), size = 1000, replace = TRUE)
}
...
The head function prints the first 6 bootstrap samples. We can see that each of these bootstrap samples include 1000 randomly sampled numbers without replacement from the original 1000 observations. The entire sample_list is populated with 1000 samples, where each sample holds 1000 observations.
