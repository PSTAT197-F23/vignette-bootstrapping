...
_Note that random forests cannot predict or extrapolate for regression problems._$^3$ _Will change to categorical response later._
...
Our random forest model achieved a test set error of 0.0648. Compare this value to the test set error of our model with bagging.
